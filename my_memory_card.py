...
question_list.append(Question('Какого цвета нету на флаге России?','Зелёный','Красный','Белый','Синий'))
question_list.append(Question('Национальная хижина якутов','Юрта','Ураса','Иглу','Хата'))

app = QApplication([])

btn_OK = QPushButton('Ответить')
lb_Qestion = QLabel('Самый сложный вопрос в мире!')
...
layout_line1.addWidget(lb_Qestion, alignment=(Qt.AlignHCenter))
...
def check_answer():
        if answers[0].isChecked():
                ...
                print('Рейтинг: ',round(window.score/window.total*100,2),'%')
...
def next_question():
        window.total += 1
        print('Статистика\nВсего вопросов: ',window.total,'\nПравильных ответов: ',window.score)
        cur_qestion = randint(0,len(question_list)-1)
        q = question_list[cur_qestion]
        ask(q)
